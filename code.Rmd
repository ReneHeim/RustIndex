...
_Backhousia citriodora_. It is structured according to the method section in our 
current article (Heim et al., 2018):

```{r , echo=FALSE, fig.cap="A caption", out.width = '80%', dpi=500}
...
install.packages(c("cowplot", "gdata", "roxygen2","ggplot2", "glmulti", "hsdar",
                    "rJava", "VSURF", "reshape2", "caret", "magrittr"))
```
